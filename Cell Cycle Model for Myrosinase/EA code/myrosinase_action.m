function [proliferation, peak, err] = myrosinase_action(sulforaphane_0, tf, mpf_peak, kbax_m, kcytc_m, kp21_m, mean_uptake_rate)

    Casp3_0 = 1.0e-5;

    % Myrosinase
    x0_m = zeros(3, 1);
    x0_m(1) = 0.0; % Myrosinase
    x0_m(2) = sulforaphane_0; % Sulforaphane extracellular
    ...
    % Fluctuations in the experienced sulphoraphane concentration
    ...
    [t, x] = ode23s(@(t, x) f_myrosinase_action(t, x, uptake_rate, kbax_m, kcytc_m, kp21_m), tI, x0);
    [~, ID] = lastwarn;
