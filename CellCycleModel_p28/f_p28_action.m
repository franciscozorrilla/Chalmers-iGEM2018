function xdot = f_p28_action(t, x, k_uptake)
% Values of constants from Hamuda et al. (2009) unless otherwise stated.
% Fluxes assumed to be in microM/s
    ...
    % p53 system
    % Assuming only the degradation of p53 via Cop1 is affected by p28
