function xdot = f_alpha_pheromone_system(t, x, Q)
% Alpha pheromone patway with production of anti-cancer protein
% Constants and reactions from Kofahl and Klipp (2004) unless otherwise
% stated. Concentrations in nM/min
    ...
    v51 = Q * x(38) * v51_k51;
    % mRNA of alpha pheromone
    v52 = (1 - Q) * x(26) * v48_k48 / (1 + (1 - Q) * v49_k49);
    % Production of alpha pheromone
    v53 = (1 - Q) * v52 * v50_k50;
    % Degradation of alpha pheromone (non-Bar1 related)
    v54 = (1 - Q) * x(1) * v51_k51;
    
    % ODEs
    xdot = zeros(38, 1);
    % Alpha-factor, with added reactions
    xdot(1) = - v1 + v53 - v54;
    % Ste2
    xdot(2) = - v2 + v3 - v5;
    % Ste2a
    ...
    % mRNA anti-cancer agent
    xdot(37) = v48 - v49;
    % Protein anti-cancer agent
    xdot(38) = v50 - v51;
