function xdot = f_p28_action(t, x, source_p53, d_p53, f1, d_Mdm2, f2, d_cop1, k_deg_cop1, k_uptake, deg_basal, d_p28, k_67_a)
...
% Fluxes assumed to be in microM/s
    ...
    k_p28_1 = 0.86; % Moscetti et al. (2017) 
    k_p28_2 = 5.6e-3; % Moscetti et al. (2017)

    % Cell cycle arrest, Aguda et al.
    k1_c = 1.0;
    k1_0_c = 1.0;
    k2_c = 0.001;
    k2_0_c = 0.01;
    ...
    % p53 system
    % Assuming only degradation via Cop1 is affected by p28
    P1 = source_p53 - d_p53 * (x_p(1) + x_p(6)) - deg_basal * (x_p(1) + x_p(6)) * x_p(2); 
    P2 = f1 - d_Mdm2 *  x_p(2);
    P3 = k_cop1_1 * x_p(1) * x_p(3) - k_cop1_2 * x_p(4);
    P4 = f2 - d_cop1 * x_p(3);
    P5 = k_deg_cop1 * x_p(4);
    P6 = k_p28_1 * x_p(1) * x_p(5) - k_p28_2 * x_p(6);
    P7 = k_uptake * x_p(7);
    P8 = d_p28 * x_p(5);
    ...
    C12 = k12_c * x_c(6);
    C13 = k13_c;
    C14 = k14_c / (1 + k14_0_c * (x_p(1) + x_p(6)));
    C15 = k15_c * x_c(10)^2;
    C16 = k16_c;
    C17 = k17_c * x_c(8);
    C18 = k18_c * x_c(10) * x_c(4) + k_Plk1_0 * x_c(4);
    C18_ = k18_0_c *x_c(2);
    C20 = k20_c * (x_p(1) + x_p(6));
    C21 = k21_c;
    C22 = k22_c * x_c(9);
    ...
    R_A3 = k_66_a * x_a(32);
    R_A4 = k_67_a * ((x_p(1) + x_p(6))^4/((x_p(1) + x_p(6))^4  +  p53_thresh^4));
    ...
    xdot_c(9) = C20 +  C21 - C22 - C23 +  C23_ - R_A2 - R_A1 + R_A3;	
    % MPF
    ...
    P_Bax = P_oBax * (1 + (x_p(1) + x_p(6))^4/((x_p(1) + x_p(6))^4  +  p53_thresh^4)); 
    A_Bax = P_Bax - u_Bax * x_a(11);
    A_13 = k13_a * x_a(12) * x_a(11);
    P_Bcl_2 = P_oBcl_2 * p53_thresh^4/((x_p(1) + x_p(6))^4  +  p53_thresh^4);
    ...
    xdot_a = zeros(32, 1);
    % Caspase8, with added reaction do demonstrate upregulation in apoptosis
    ...
    xdot_a(4) = A_1 - 7 * A_1b;
    % CytochromeC
    xdot_a(5) = A_14 - A_1 + A_Cytc;
    % CytochromeC mitochondria
    xdot_a(6) = - A_14 + A_Cytc_mito;
    % Bax_2
    ...
    % Bax
    xdot_a(11) = - A_12a - A_12b - A_13 + A_Bax;
    % Bcl_2
