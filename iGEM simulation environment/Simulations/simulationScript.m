...
[modelBth, addedRxnsBth]=addExchangeRxns(modelBth,'in',{'m468','m714'});%add exch rxns for methionine and tryptophan
...
[modelEre, addedRxnsBth]=addExchangeRxns(modelEre,'in',{'m218','m296'});%add exch rxns for methionine and tryptophan
...
plot(t,xa(:,23:31))
xlabel('Time (hours)'), ylabel('Concentration (mmol/gDCW)')
legend('Carbon dioxide','Propanoate','Butyrate','Succinate','Ethanol','Methane','MFalpha2','Myrosinase')